...
@section('content')
    ...
    {{ Form::model($blog, array('route' => array('general.blogs.update', $blog->id), 'method' => 'PUT', 'class'=>'needs-validation')) }}
    <div class="row mt-3">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            {{ Form::text('title', null, array('class' => 'form-control','required'=>'required', 'placeholder' => __('Enter'))) }}
                        </div>
                        <div class="form-group col-md-12 editor_pad_remover">
                            {!! Form::label('description', __('Description'),['class'=>'form-label']) !!}<x-required></x-required>
                            <textarea class="form-control summernote-simple-2" name="description" id="exampleFormControlTextarea2" rows="15" placeholder="Enter">{{ $blog->description }}</textarea>
                        </div>
                        <div class="form-group col-md-6">
