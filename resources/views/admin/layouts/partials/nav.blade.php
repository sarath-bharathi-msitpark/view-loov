            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-8">
                    <div class="d-flex justify-content-start align-items-center gap-2">
                        <img class="me-md-4" src="{{ asset('assets/assestsnew/loov2.ologo_2.svg') }}"
                             alt="Header Icon"/>
                        <img src="@yield('page-icon', asset('assets/assestsnew/settings.svg'))"
                             alt="Header Icon" width="32" height="32"/>
                        <h5 class="fw-semibold fs-2 let_1 mb-0">@yield('page-title')</h5>
                    </div>
                </div>

                <div class="col-xl-6 col-4 d-flex justify-content-end align-items-center d-xl-none mt-0">
                    <button class="header_toggle_btn"
                            onclick="document.querySelector('.responsive_toggle_content').classList.toggle('show')">
                        <span class="bar"></span>
                        <span class="bar"></span>
                        <span class="bar"></span>
                    </button>
                ...
                <!-- TOGGLED CONTENT -->
                <div class="col-md-6 responsive_toggle_content">
                    <div
                        class="d-flex justify-content-end align-items-center flex-wrap flex-xl-row flex-column gap-3 mt-3 mt-md-0">
                        <div class="help">
                            <div class="dropdown text-center position-relative">
                                ...
                                <ul class="dropdown-menu dropdown-menu-center bg-transparent border-0 p-0 rounded-0">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <img
                                ...
                                alt="Logo" class="rounded-circle" width="38" height="38"/>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu border-0 p-0 bg-transparent dropdown-menu-end shadow-none">
                                    <div class="container-center">
                                        <div class="account-card">
                                            <div class="profile-section">
                                                ...
                                                <div>
                                                    <h6 class="mb-0 text-black fw-semibold fs-6">{{ \Illuminate\Support\Facades\Auth::user()->company_name }}</h6>
                                                    <small
                                            ...
                                            <a href="#"
                                               class="menu-item self_hov1 px-2"
                                               style="color: #6B6B6B;"
                                               data-bs-toggle="modal"
                                               data-bs-target="#downloadModal"
                                            >
                                            ...
                                            <a href="#!" data-url="{{ route('general.change.password') }}"
                                               data-ajax-popup="true" data-size="md" class="menu-item self_hov1 px-2"
                                               style="color: #6B6B6B;">
                                                <div class="menu-icon">
                                                    <i class="ti ti-key" style="font-size: 24px"></i>
                                                </div>
