                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <span class="text-sm d-block mb-2">{{ __('Application URL to log into the app.') }}</span>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <span class="text-sm d-block mb-2">{{ __('Image Screenshot Take Interval time ( 1 = 1 min)') }}</span>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select type="text" name="cashfree_mode"
                                                                                ...
                                                                                <option value="dot"
                                                                                    @if (@$setting['cashfree_mode'] == 'sandbox') selected="selected" @endif>
                                                                                    {{ __('Sandbox') }}</option>
                                                                                <option value="comma"
                                                                                    @if (@$setting['cashfree_mode'] == 'production') selected="selected" @endif>
