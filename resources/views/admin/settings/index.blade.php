...
<style>
    ...
    @media (min-width: 1200px) {
        .setting-sidebar {
            width: 22% !important; /* or use Bootstrap col-3 class */
            position: fixed !important;
            top: 100px !important;
            height: fit-content; /* Keeps it from stretching */
            /*z-index: 0;*/
        }
...
@push('script-page')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var scrollSpy = new bootstrap.ScrollSpy(document.body, {
                target: '#useradd-sidenav',
                offset: 100 // adjust based on your layout (70-120 is common)
            });


            const listItems = document.querySelectorAll('#useradd-sidenav .list-group-item');
            if (listItems.length > 0) {
                listItems[0].classList.add('active');
            }

            // Ensure only one item stays active on click
            ...
            custthemedark.addEventListener("click", function () {
                if (custthemedark.checked) {
                    $('#main-style-link').attr('href', '{{ config('app.url') }}' +
                        '/publicassets/css/style-dark.css');
                    ...
                    $('#main-style-link').attr('href', '{{ config('app.url') }}' + '/publicassets/css/style.css');
...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="row" id="scrollspy-content"
                 data-bs-spy="scroll"
                 data-bs-target="#useradd-sidenav"
                 data-bs-offset="100"
                 tabindex="0"
                 style="position: relative; height: 80vh; overflow-y: auto;">
                <div class="col-xl-3 settings-wrapper" style="z-index:0">
                    <div class=" sticky-top setting-sidebar" style="top:30px">
                        <div class="list-group list-group-flush setting-sidebar mt-4" id="useradd-sidenav">
                            ...
                            <a href="#download-link-settings"
                               class="list-group-item list-group-item-action border-0">{{ __('Download Loov') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                            <a href="#field-track-download-link-settings"
                               class="list-group-item list-group-item-action border-0">{{ __('Download Loov Field Track') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                ...
                <div class="col-xl-9 setting-content">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('contact_support', __('Contact Support Number'), ['class' => 'form-label']) }}
                                            {{ Form::text('contact_support', Utility::getValByName('contact_support'), ['class' => 'form-control', 'placeholder' => __('Enter contact support number')]) }}
                                            @error('contact_support')
                                            <span class="invalid-contact_support" role="alert">
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                </span>
                                            @enderror
                                        </div>
                    ...
                    <div id="email-settings" class="card">
                        ...
                        <div class="card-body">
                            {{ Form::open(['route' => 'admin.email.settings', 'method' => 'post']) }}
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="card-footer d-flex justify-content-end">
                                <div class="form-group me-4">
                                    <a href="#" data-url="{{ route('admin.testing.mail') }}"
                                       data-title="{{ __('Send Test Mail') }}"
                                       class="btn btn-primary send_email me-1 mb-3">
                                        {{ __('Send Test Mail') }}
                                    </a>
                                    <input class="btn btn-primary mb-3" type="submit" value="{{ __('Save Changes') }}">
                                </div>
                    ...
                    <div class="card" id="payment-settings">
                        ...
                        {{ Form::open(['route' => 'admin.payment.settings', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="col-form-label">{{ __('Default Price of Per User') }}
                                                *</label>

                                            {{ Form::number('default_price_per_user', isset($admin_payment_setting['default_price_per_user']) ? $admin_payment_setting['default_price_per_user'] : '', ['class' => 'form-control font-style', 'required', 'placeholder' => __('Enter Default Price of Per User')]) }}
                                        </div>
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="headingOne">
                                                            <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    data-bs-target="#collapseManually"
                                                                    aria-expanded="false"
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="input-edits">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <br>
                                                                                <label
                                                                                    class="form-label mt-3">{{ __('Bank UPI QR') }}</label>
                                                                                <input type="file" name="bank_upi_qr"
                                                                                       class="form-control"
                                                                                       accept="image/*">

                                                                                @if(!empty($admin_payment_setting['bank_upi_qr']))
                                                                                    <div class="mt-2">
                                                                                        <img
                                                                                            src="{{ \App\Models\Utility::get_file($admin_payment_setting['bank_upi_qr']) }}"
                                                                                            alt="Bank QR" height="100">
                                                                                    </div>
                                                                                @endif
                                                                            </div>
                                                                        </div>
                                                                                    ...
                                                                                    <div class="form-check">
                                                                                        <label
                                                                                            ...
                                                                                            <input type="radio"
                                                                                                   ...
                                                                                                   value="live"
                                                                                                   class="form-check-input"
                                                                                                {{ ($admin_payment_setting['iyzipay_mode'] ?? '') == 'live' ? 'checked' : '' }}>
                                                                                            {{ __('Live') }}
                                                                                        </label>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="input-edits">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text"
                                                                                           ...
                                                                                           class="form-control"
                                                                                           value="{{ $admin_payment_setting['iyzipay_public_key'] ?? '' }}"
                                                                                           placeholder="{{ __('Public Key') }}">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div id="collapseTwentyTwo" class="accordion-collapse collapse"
                                                            ...
                                                            <div class="accordion-body">
                                                                <div class="row gy-4">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            <label for="cashfree_mode" class="col-form-label">{{ __('Mode') }}</label>
                                                                            <select type="text" name="cashfree_mode"
                                                                                class="form-control selectric currency_preview" id="cashfree_mode">
                                                                                <option value="" @if (@$admin_payment_setting['cashfree_mode'] == '') selected="selected" @endif>
                                                                                    {{ __('Select') }}</option>
                                                                                <option value="sandbox" @if (@$admin_payment_setting['cashfree_mode'] == 'sandbox') selected="selected" @endif>
                                                                                    {{ __('Sandbox') }}</option>
                                                                                <option value="production" @if (@$admin_payment_setting['cashfree_mode'] == 'production') selected="selected" @endif>
                                                                ...
                                                                <div class="row pt-2">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('aamarpay_store_id', isset($admin_payment_setting['aamarpay_store_id']) ? $admin_payment_setting['aamarpay_store_id'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Store Id')]) }}
                                                                            <br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('aamarpay_signature_key', isset($admin_payment_setting['aamarpay_signature_key']) ? $admin_payment_setting['aamarpay_signature_key'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Signature Key')]) }}
                                                                            <br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('aamarpay_description', isset($admin_payment_setting['aamarpay_description']) ? $admin_payment_setting['aamarpay_description'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Description')]) }}
                                                                            <br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('paytr_merchant_id', isset($admin_payment_setting['paytr_merchant_id']) ? $admin_payment_setting['paytr_merchant_id'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Id')]) }}
                                                                            <br>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('paytr_merchant_key', isset($admin_payment_setting['paytr_merchant_key']) ? $admin_payment_setting['paytr_merchant_key'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Key')]) }}
                                                                            <br>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('paytr_merchant_salt', isset($admin_payment_setting['paytr_merchant_salt']) ? $admin_payment_setting['paytr_merchant_salt'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Salt')]) }}
                                                                            <br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('yookassa_shop_id', isset($admin_payment_setting['yookassa_shop_id']) ? $admin_payment_setting['yookassa_shop_id'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Id')]) }}
                                                                            <br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('yookassa_secret', isset($admin_payment_setting['yookassa_secret']) ? $admin_payment_setting['yookassa_secret'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Key')]) }}
                                                                            <br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('midtrans_secret', isset($admin_payment_setting['midtrans_secret']) ? $admin_payment_setting['midtrans_secret'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Id')]) }}
                                                                            <br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('xendit_api', isset($admin_payment_setting['xendit_api']) ? $admin_payment_setting['xendit_api'] : '', ['class' => 'form-control', 'placeholder' => __('API Key')]) }}
                                                                            <br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('xendit_token', isset($admin_payment_setting['xendit_token']) ? $admin_payment_setting['xendit_token'] : '', ['class' => 'form-control', 'placeholder' => __('Token')]) }}
                                                                            <br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('nepalste_public_key', isset($admin_payment_setting['nepalste_public_key']) ? $admin_payment_setting['nepalste_public_key'] : '', ['class' => 'form-control', 'placeholder' => __('API Key')]) }}
                                                                            <br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('nepalste_secret_key', isset($admin_payment_setting['nepalste_secret_key']) ? $admin_payment_setting['nepalste_secret_key'] : '', ['class' => 'form-control', 'placeholder' => __('Token')]) }}
                                                                            <br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('paiementpro_merchant_id', isset($admin_payment_setting['paiementpro_merchant_id']) ? $admin_payment_setting['paiementpro_merchant_id'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Id')]) }}
                                                                            <br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('cinetpay_api_key', isset($admin_payment_setting['cinetpay_api_key']) ? $admin_payment_setting['cinetpay_api_key'] : '', ['class' => 'form-control', 'placeholder' => __('CinetPay API Key')]) }}
                                                                            <br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('cinetpay_site_id', isset($admin_payment_setting['cinetpay_site_id']) ? $admin_payment_setting['cinetpay_site_id'] : '', ['class' => 'form-control', 'placeholder' => __('CinetPay Site ID')]) }}
                                                                            <br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('fedapay_public', isset($admin_payment_setting['fedapay_public']) ? $admin_payment_setting['fedapay_public'] : '', ['class' => 'form-control', 'placeholder' => __('Public Key')]) }}
                                                                            <br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('fedapay_secret', isset($admin_payment_setting['fedapay_secret']) ? $admin_payment_setting['fedapay_secret'] : '', ['class' => 'form-control', 'placeholder' => __('Secret Key')]) }}
                                                                            <br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('payhere_merchant_id', isset($admin_payment_setting['payhere_merchant_id']) ? $admin_payment_setting['payhere_merchant_id'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant ID')]) }}
                                                                            <br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('payhere_merchant_secret', isset($admin_payment_setting['payhere_merchant_secret']) ? $admin_payment_setting['payhere_merchant_secret'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Secret')]) }}
                                                                            <br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('payhere_app_id', isset($admin_payment_setting['payhere_app_id']) ? $admin_payment_setting['payhere_app_id'] : '', ['class' => 'form-control', 'placeholder' => __('App ID')]) }}
                                                                            <br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('payhere_app_secret', isset($admin_payment_setting['payhere_app_secret']) ? $admin_payment_setting['payhere_app_secret'] : '', ['class' => 'form-control', 'placeholder' => __('App Secret')]) }}
                                                                            <br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('company_tap_secret_key', isset($admin_payment_setting['company_tap_secret_key']) ? $admin_payment_setting['company_tap_secret_key'] : '', ['class' => 'form-control', 'placeholder' => __('Secret Key')]) }}
                                                                            <br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('company_authorizenet_client_id', isset($admin_payment_setting['company_authorizenet_client_id']) ? $admin_payment_setting['company_authorizenet_client_id'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Login Id')]) }}
                                                                            <br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('company_authorizenet_secret_key', isset($admin_payment_setting['company_authorizenet_secret_key']) ? $admin_payment_setting['company_authorizenet_secret_key'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Transaction Key')]) }}
                                                                            <br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('khalti_public_key', isset($admin_payment_setting['khalti_public_key']) ? $admin_payment_setting['khalti_public_key'] : '', ['class' => 'form-control', 'placeholder' => __('Public Key')]) }}
                                                                            <br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('khalti_secret_key', isset($admin_payment_setting['khalti_secret_key']) ? $admin_payment_setting['khalti_secret_key'] : '', ['class' => 'form-control', 'placeholder' => __('Secret Key')]) }}
                                                                            <br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('easebuzz_merchant_key', isset($admin_payment_setting['easebuzz_merchant_key']) ? $admin_payment_setting['easebuzz_merchant_key'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Key')]) }}
                                                                            <br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Form::text('easebuzz_salt_key', isset($admin_payment_setting['easebuzz_salt_key']) ? $admin_payment_setting['easebuzz_salt_key'] : '', ['class' => 'form-control', 'placeholder' => __('Salt Key')]) }}
                                                                            <br>
                    ...
                    <div id="pusher-settings" class="card">
                        ...
                        {{ Form::model($settings, ['route' => 'admin.pusher.setting', 'method' => 'post']) }}
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group col switch-width">
                                            ...
                                            {{ Form::select('google_recaptcha_version', $google_recaptcha_version, isset($setting['google_recaptcha_version']) ? $setting['google_recaptcha_version'] : 'v2-checkbox', ['id' => 'google_recaptcha_version', 'class' => 'form-control choices select2', 'searchEnabled' => 'true']) }}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    </div>
                    ...
                    <div id="storage-settings" class="card mb-3">
                        {{ Form::open(['route' => 'admin.storage.setting.store', 'enctype' => 'multipart/form-data', 'id' => 'storage-settings-form']) }}
                        <div class="card-header">
                            <div class="row">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="pe-2">
                                    <input type="radio" class="btn-check" name="storage_setting" id="s3-outlined"
                                           ...
                                           value="s3">
                                    <label class="btn btn-outline-primary text-nowrap" for="s3-outlined">
                                        {{ __('AWS S3') }}</label>
                                </div>
                                <div class="pe-2">
                                    <input type="radio" class="btn-check" name="storage_setting"
                                ...
                                <div class="s3-setting row {{ $setting['storage_setting'] == 's3' ? ' ' : 'd-none' }}">
                                    <div class=" row ">
                                        ...
                                        <div class="form-group col-8 switch-width">
                                            ...
                                            <select name="s3_storage_validation[]" class="select2 multiple"
                                    ...
                                    <div class=" row mt-2">
                                        ...
                                        <div class="form-group col-8 switch-width">
                                            ...
                                            <select name="wasabi_storage_validation[]" class="select2"
                                                ...
                                                @foreach ($file_type as $f)
                                                    <option
                                                        @if (in_array($f, $wasabi_storage_validations)) selected @endif>
                                                        {{ $f }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                    ...
                    <div id="seo-settings" class="card">
                                ...
                                <div class="d-flex justify-content-end">
                                    <div class="mt-0">
                                        <a data-size="md" class="btn btn-primary text-white btn-sm"
                                           data-ajax-popup-over="true" data-url="{{ route('admin.generate', ['seo']) }}"
                        ...
                        {{ Form::open(['url' => route('admin.seo.settings.store'), 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{ Form::textarea('meta_desc', !empty($setting['meta_desc']) ? $setting['meta_desc'] : '', ['class' => 'form-control mt-0', 'placeholder' => 'Meta Description', 'rows' => 7, 'style' => 'border-radius:10px;']) }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                    ...
                                    @if (!empty($settings['chat_gpt_key']))
                                        <div class="mt-o">
                                            <a data-size="md" class="btn btn-primary text-white btn-sm"
                                               ...
                                               data-url="{{ route('admin.generate', ['cookie']) }}"
                            ...
                            <div class="row ">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::textarea('cookie_description', null, ['class' => 'form-control cookie_setting  mt-0', 'rows' => '3', 'placeholder'=>__('Cookie Description')]) !!}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        {!! Form::textarea('strictly_cookie_description', null, [
                                            'class' => 'form-control cookie_setting  mt-0',
                    ...
                    <div class="card" id="cache-settings">
                        ...
                        <form method="POST" action="{{ route('admin.cache.settings.store') }}" accept-charset="UTF-8">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div id="chat-gpt-settings" class="card">
                        ...
                        {{ Form::model($settings, ['route' => 'admin.chatgpt.settings', 'method' => 'post']) }}
                        <div class="card-body">
                            <div class="row">
                    ...
                    <div id="download-link-settings" class="card">
                        <div class="card-header">
                            <h5>{{ __('Download LOOV link') }}</h5>
                        </div>
                        {{ Form::model($settings, ['route' => 'admin.downloadlink.settings', 'method' => 'post']) }}
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    {{ Form::label('window_stel_user', __('Windows (Stealth User)'), ['class' => 'col-form-label']) }}
                                    {{ Form::text('window_stel_user', isset($settings['window_stel_user']) ? $settings['window_stel_user'] : '', ['class' => 'form-control', 'placeholder' => __('Enter '), 'required' => 'required']) }}
                                </div>
                                <div class="form-group col-md-6">
                                    {{ Form::label('window_stel_user_version', __('Windows (Stealth User Version)'), ['class' => 'col-form-label']) }}
                                    {{ Form::text('window_stel_user_version', isset($settings['window_stel_user_version']) ? $settings['window_stel_user_version'] : '', ['class' => 'form-control', 'placeholder' => __('Enter '), 'required' => 'required']) }}
                                </div>
                                <div class="form-group col-md-6">
                                    {{ Form::label('window_stand_user', __('Windows (Standard User)'), ['class' => 'col-form-label']) }}
                                    {{ Form::text('window_stand_user', isset($settings['window_stand_user']) ? $settings['window_stand_user'] : '', ['class' => 'form-control', 'placeholder' => __('Enter '), 'required' => 'required']) }}
                                </div>
                                <div class="form-group col-md-6">
                                    {{ Form::label('window_stand_user_version', __('Windows (Standard User Version)'), ['class' => 'col-form-label']) }}
                                    {{ Form::text('window_stand_user_version', isset($settings['window_stand_user_version']) ? $settings['window_stand_user_version'] : '', ['class' => 'form-control', 'placeholder' => __('Enter '), 'required' => 'required']) }}
                                </div>
                                <div class="form-group col-md-6">
                                    {{ Form::label('mac_stel_user', __('Mac (Stealth User)'), ['class' => 'col-form-label']) }}
                                    {{ Form::text('mac_stel_user', isset($settings['mac_stel_user']) ? $settings['mac_stel_user'] : '', ['class' => 'form-control', 'placeholder' => __('Enter '), 'required' => 'required']) }}
                                </div>
                                <div class="form-group col-md-6">
                                    {{ Form::label('mac_stel_user_version', __('Mac (Stealth User Version)'), ['class' => 'col-form-label']) }}
                                    {{ Form::text('mac_stel_user_version', isset($settings['mac_stel_user_version']) ? $settings['mac_stel_user_version'] : '', ['class' => 'form-control', 'placeholder' => __('Enter '), 'required' => 'required']) }}
                                </div>
                                <div class="form-group col-md-6">
                                    {{ Form::label('mac_stand_user', __('Mac (Standard User)'), ['class' => 'col-form-label']) }}
                                    {{ Form::text('mac_stand_user', isset($settings['mac_stand_user']) ? $settings['mac_stand_user'] : '', ['class' => 'form-control', 'placeholder' => __('Enter'), 'required' => 'required']) }}
                                </div>
                                <div class="form-group col-md-6">
                                    {{ Form::label('mac_stand_user_version', __('Mac (Standard User Version)'), ['class' => 'col-form-label']) }}
                                    {{ Form::text('mac_stand_user_version', isset($settings['mac_stand_user_version']) ? $settings['mac_stand_user_version'] : '', ['class' => 'form-control', 'placeholder' => __('Enter'), 'required' => 'required']) }}
                                </div>
                    ...
                    <div id="field-track-download-link-settings" class="card">
                        <div class="card-header">
                            <h5>{{ __('Download Field Track LOOV link') }}</h5>
                        </div>
                        {{ Form::model($settings, ['route' => 'admin.downloadlink.settings', 'method' => 'post']) }}
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    {{ Form::label('field_track_loov', __('Field Track (Android)'), ['class' => 'col-form-label']) }}
                                    {{ Form::text('field_track_loov', isset($settings['field_track_loov']) ? $settings['field_track_loov'] : '', ['class' => 'form-control', 'placeholder' => __('Enter '), 'required' => 'required']) }}
                                </div>
                                <div class="form-group col-md-6">
                                    {{ Form::label('field_track_loov_version', __('Field Track Version (Android)'), ['class' => 'col-form-label']) }}
                                    {{ Form::text('field_track_loov_version', isset($settings['field_track_loov_version']) ? $settings['field_track_loov_version'] : '', ['class' => 'form-control', 'placeholder' => __('Enter '), 'required' => 'required']) }}
                                </div>
                            </div>
                        </div>
                        <div class="card-footer text-end">
