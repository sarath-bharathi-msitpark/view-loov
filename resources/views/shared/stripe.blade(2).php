                            ...
                            <div class="card price-card price-1 wow animate__fadeInUp" data-wow-delay="0.2s"
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mb-4 f-w-600 mt-4">
                                        Plan Price: {{ isset($admin_payment_setting['currency_symbol']) ? $admin_payment_setting['currency_symbol'] : '$' }}{{ number_format($plan->total_amount, 2, '.', ',') }} 
                                    </h4>
                                            ...
                                            <div class="col-6 "> 
                                                ...
                                                <div><strong>QR Code</strong></div> <br>
                                                    @php
                                                        ...
                                                        $data1 = base64_encode(file_get_contents($path1));
                                                        $src1 = 'data:image/' . $type1 . ';base64,' . $data1;
                                                    @endphp
                                                    <img src="{{ $src1 }}" alt="UPI QR" class="img-thumbnail" style="max-width: 44%;">
                                                @endif
                                            </div> 
                                        </div><br><br>
                    ...
                    @if (
                        ...
                        <div id="stripe_payment" class="card">
                            ...
                            <div class="tab-pane {{ ($admin_payment_setting['is_stripe_enabled'] == 'on' && !empty($admin_payment_setting['stripe_key']) && !empty($admin_payment_setting['stripe_secret'])) == 'on' ? 'active' : '' }}"
                                id="stripe_payment">
                                <form role="form" action="{{ route('general.stripe.post') }}" method="post"
