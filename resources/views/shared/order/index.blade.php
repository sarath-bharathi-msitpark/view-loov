                ...
                <div class="card-body table-border-style">
                    <div class="table-responsive company_order_table">
                        <table class="table datatable">
                            <thead>
                            <tr>
                                <th style="position: unset; background-color: transparent">{{ __('Order Id') }}</th>
                            ...
                            @foreach ($orders as $key => $order)
                                <tr>
                                    <td class="tex_fix" style="position: unset;">{{ $order->order_id }}</td>
                                    ...
                                    <td class="Id">
                                        ...
                                        @elseif(strtoupper($order->payment_type) == 'STRIPE')
                                            ...
                                            <span>
                                                    ...
                                                    @if (
                                                        ...
                                                        <div class="badge bg-warning p-2 px-3">
                                                                <a href="{{ route('general.order.refund', [$order->id, $order->user_id]) }}"
