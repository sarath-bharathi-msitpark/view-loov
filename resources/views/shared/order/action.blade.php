                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-btn">
                                <a  class=" bg-primary ms-2 btn btn-sm align-items-center" href="{{ \App\Models\Utility::get_file($order->receipt) }}" download=""  data-bs-toggle="tooltip" title="{{__('Download')}}" target="_blank">
