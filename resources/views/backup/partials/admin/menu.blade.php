...
<div class="">
   {{-- <div class="m-header main-logo">
    ...
    <div class="">
        <div class="main_logo_otune">
            <a href="#" class="b-brand">
                <!--<img class="logo_o_only" src="{{ asset('assets/images/loovO.svg') }}" alt="">-->
                <!--<img class="logomain_only" src="{{ asset('assets/images/loov_logo.svg') }}" alt="">-->
                @if ($setting['cust_darklayout'] && $setting['cust_darklayout'] == 'on')
                    <img
                        src="{{ $logo . '/' . (isset($company_favicon) && !empty($company_favicon) ? $company_favicon : 'logo-dark.png') . '?' . time() }}"
                        alt="{{ config('app.name', 'ERPGo-SaaS') }}" class="logo_o_only">
                    <img
                        src="{{ $logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-dark.png') . '?' . time() }}"
                        alt="{{ config('app.name', 'ERPGo-SaaS') }}" class="logomain_only">
                @else
                    <img
                        src="{{ $logo . '/' . (isset($company_favicon) && !empty($company_favicon) ? $company_favicon : 'logo-light.png') . '?' . time() }}"
                        alt="{{ config('app.name', 'ERPGo-SaaS') }}" class="logo_o_only">
                    <img
        ...
        {{--    <ul class="dash-navbar">
            ...
            <div class="main_sidebar">
                <div class="row px-0 h-100">
                    <div class="main_linksbar">
                        <div class="row links_content justify-content-center">
                            <div class="logo">
                                <img src="{{ asset('assets/assestsnew/logo.png') }}" alt="">
                            </div>
                            <div class="logo1">
                                <img src="{{ asset('assets/assestsnew/loov2.ologo_2.svg') }}" alt="">
                            </div>
                            <div class="text-center main_icononly">
                                <div class="sidebar_logo active_logo">
                                    <img class="img_side_logo active_side_logo" src="{{ asset('assets/assestsnew/dasboard.svg') }}" alt="">
                                </div>
                                <div class="sidebar_logo">
                                    <img class="img_side_logo " src="{{ asset('assets/assestsnew/screenshotlogo.svg') }}" alt="">
                                </div>
                                <div class="sidebar_logo ">
                                    <img class="img_side_logo " src="{{ asset('assets/assestsnew/livestreamlogo.svg') }}" alt="">
                                </div>
                                <div class="sidebar_logo ">
                                    <img class="img_side_logo" src="{{ asset('assets/assestsnew/app-urllogo.svg') }}" alt="">
                                </div>
                                <div class="sidebar_logo">
                                    <img class="img_side_logo" src="{{ asset('assets/assestsnew/reportslogo.svg') }}" alt="">
                                </div>
                                <div class="sidebar_logo">
                                    <img class="img_side_logo" src="{{ asset('assets/assestsnew/donut-chart.svg') }}" alt="">
                                </div>
                                <div class="sidebar_logo">
                                    <img class="img_side_logo" src="{{ asset('assets/assestsnew/settingslogo.svg') }}" alt="">
                                </div>
                                
                            </div>

                            <div class="row  main_text_link">
                                <div class="active_link d-flex justify-content-start align-items-center gap-3">
                                    <img class="img_side_logo active_side_logo mb-0" src="{{ asset('assets/assestsnew/dasboard.svg') }}" alt="">
                                    <a class="px-0" href="{{ route('dashboard')}}">Dashboard</a>
                                </div>
                                <div class="d-flex justify-content-start align-items-center gap-1">
                                    <img src="{{ asset('assets/assestsnew/screenshotlogo.svg') }}" alt="">
                                    <a href="{{ route('screenshot.index')}}">Screenshots</a>
                                </div>
                                <div class="d-flex justify-content-start align-items-center gap-1">
                                    <img src="{{ asset('assets/assestsnew/livestreamlogo.svg') }}" alt="">
                                    <a href="{{ route('live_screenshot.index')}}">Live Stream</a>
                                </div>
                                <div class="d-flex justify-content-start align-items-center gap-1">
                                    <img src="{{ asset('assets/assestsnew/app-urllogo.svg') }}" alt="">
                                    <a href="{{ route('apps_and_urls.index')}}">App & URLs</a>
                                </div>
                                <div class="d-flex justify-content-start align-items-center gap-1">
                                    <img src="{{ asset('assets/assestsnew/reportslogo.svg') }}" alt="">
                                    <a href="{{ route('report.index')}}">Reports</a>
                                </div>
                                <div class="d-flex justify-content-start align-items-center gap-1">
                                    <img src="{{ asset('assets/assestsnew/donut-chart.svg') }}" alt="">
                                    <a href="{{ route('employee.attendance')}}">Attendance</a>
                                </div>
                                <div class="d-flex justify-content-start align-items-center gap-1">
                                    <img src="{{ asset('assets/assestsnew/settingslogo.svg') }}" alt="">
