...
@section('content')
    ...
    @if(Auth::user()->type == 'company')
        <div class="row">
            <div class="col-sm-12">
                <div class="mt-2 ">
                    <div class="card padd_mobilezero">
                        <div class="card-body">
                            ...
                            <div class="row d-flex align-items-center justify-content-end">
                                <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12 mr-2 mb-0">
                                    <div class="btn-box">
                                        {{ Form::label('users', __('Users'),['class'=>'form-label mt-md-0 mt-3'])}}
                                        <select class="select form-select mt-0 w-100" name="all_users" id="all_users">
                                            <option value="" class="">{{ __('All Users') }}</option>
                                            @foreach ($users as $user)
                                                <option
                                                    value="{{ $user->id }}" {{isset($_GET['all_users']) && $_GET['all_users']==$user->id?'selected':''}}>{{ $user->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
    ...
    <div class="col-xl-12 mt-3">
        <div class="card table-card padd_mobilezero">
            <div class="card-header card-body table-border-style">
                <div class="table-responsive table_inside_scroll">
                    <table class="table datatable">
                                    ...
                                    <td class="">
                                        ...
                                        <div class="action-btn me-2">
                                            <a href="{{ route('project_report.show', $project->id) }}"
                                               ...
                                               data-bs-toggle="tooltip" title="{{__('View Project Report')}}"
                        ...
                        @else
                            <tr>
                                <th scope="col" colspan="7"><h6 class="text-center">{{__('No Projects Found.')}}</h6>
                                </th>
                            </tr>
                        @endif
