...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row  justify-content-between" id="printableArea">
                            ...
                            <div class="row align-items-center justify-content-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-0">
                                                ...
                                                @if($project->status == 'in_progress')
                                                    <div
                                                        class="badge status_badge bg-primary p-2 px-3 rounded"> {{ __('In Progress')}}</div>
                                                @elseif($project->status == 'on_hold')
                                                    <div
                                                        class="badge status_badge bg-secondary p-2 px-3 rounded">{{ __('On Hold')}}</div>
                                                @elseif($project->status == 'Canceled')
                                                    <div
                                                        class="badge status_badge bg-danger p-2 px-3 rounded"> {{ __('Canceled')}}</div>
                                                @else
                                                    <div
                                                        class="badge status_badge bg-warning p-2 px-3 rounded">{{ __('Finished')}}</div>
                                                @endif
                                            </td>
                                        </tr>
                                ...
                                <div class="col-xl-5 col-lg-6">
                                    ...
                                    <div class="circular-progressbar p-0">
                                        <div class="flex-wrapper d-flex justify-content-center">
                    ...
                    <div class="card bg-white mb-0 h-100">
                        ...
                        <div class="card-body">
                            <div class="chart">
                                ...
                                <div id="milestone-chart" class="chart-canvas chartjs-render-monitor"
                                     height="150"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card bg-white h-100 mb-0">
                        ...
                        <div class="card-body table-border-style mt-5">
                            <div class="table-responsive milestone m-0 w-100">
                                <table class="table">
                                    <thead>
                                    <tr>
                                        <th>{{__('Name')}}</th>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card bg-white h-100 mb-0">
                        ...
                        <div class="card-body table-border-style mt-5 px-xl-2">
                            <div class="table-responsive milestone m-0 w-100">
                                <table class="table">
                                    <thead>
                                    <tr>
                                    ...
                                    @foreach($project->milestones as $milestone)
                                        <tr>
                                            ...
                                            <td> @if($milestone->status == 'complete')
                                                    <label
                                                        class="status_badge badge bg-success p-2 px-3 rounded">{{__('Complete')}}</label>
                                                @else
                                                    <label
                                                        class="status_badge badge bg-warning p-2 px-3 rounded">{{__('Incomplete')}}</label>
                                                @endif</td>
                                                            ...
                                                            @if($key<3)
                                                                <a href="#" class="avatar rounded-circle avatar-sm">
                                                                    <img src="{{$user->getImgImageAttribute()}}"
                                                                         title="{{ $user->name }}" alt="avtar-image">
                                                                </a>
                                                            @else
                                                                @break
                                                            @endif
