<div class="modal-header pb-2 pt-2">
    <h5 class="modal-title" id="exampleModalLongTitle">{{ $tracker->project_task}} <small>( {{$tracker->total}}
            , {{date('d M',strtotime($tracker->start_time))}} )</small></h5>
                            ...
                            <div class="swiper-slide" id="slide-{{$image->id}}">
                                ...
                                <div class="time_in_slider">{{date('H:i:s, d M ',strtotime($image->time))}} |
                                    ...
                                    <div class="action-btn">
                                        <a href="#" class="mt-2 btn btn-sm  align-items-center  bg-danger ms-2 "
                                           data-bs-toggle="tooltip" data-bs-original-title="{{ __('Delete') }}"
                                           title="{{ __('Delete') }}" onclick="delete_image({{$image->id}})"
