@extends('company.layouts.shareproject')
@php
...
@section('page-icon')
    {{ asset('assets/assestsnew/projects.png') }}
@endsection
...
@push('script-page')
    ...
    <script>
        function ajaxFilterTimesheetTableView() {
            ...
            $.ajax({
                ...
                url: '{{ route('organization.filter.timesheet.table.view') }}',
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.view-images', function () {
            ...
            var p_url = "{{route('organization.tracker.image.view')}}";
            var data = {
        ...
        function removeImage(id) {
            var p_url = "{{route('organization.tracker.image.remove')}}";
            var data = {id: id};
    ...
    <a href="" class="pt-3">
        <select name="language" id="language" class="btn btn-primary my-2"
            ...
            @foreach (\App\Models\Utility::languages() as $language)
                ...
                value="{{ route('organization.projects.link',[\Illuminate\Support\Facades\Crypt::encrypt($project->id), $language]) }}">{{ Str::upper($language) }}</option>
            @endforeach
        </select>
    </a>
@endsection
            ...
            <div class="card sticky-top" style="top:30px">
                <div class="list-group list-group-flush" id="useradd-sidenav">
                    ...
                    @if (  isset($result->milestone) && $result->milestone == 'on')
                        <a href="#milestone"
                           class="list-group-item list-group-item-action border-0">{{ __('Milestones') }}
                            <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                        </a>
                    @endif
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col text-end">
                                            ...
                                            <span
                                                class="h6 font-weight-bold mb-0 ">{{$project_data['task']['total'] }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col text-end">
                                            ...
                                            <span
                                                class="h6 font-weight-bold mb-0 ">{{ $project_data['task']['done'] }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col text-end">
                                            ...
                                            <span
                                                class="h6 font-weight-bold mb-0 ">{{ count($project->milestones)}}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="progress-wrapper">
                                                    ...
                                                    <div class="progress progress-xs mt-2">
                                                        <div class="progress-bar bg-info" role="progressbar"
                                                             ...
                                                             style="width: {{ $project->project_progress_copy($usr->id)['percentage'] }};"></div>
                                                    </div>
                                                </div>
                                                </p>
                                            </div>
                                            ...
                                            <tr>
                                                <td class="">
                                                    <img
                                                        ...
                                                        @endif   class="avatar rounded border-2 border border-primary"
                        ...
                        <div class="card-body table-border-style">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    @else
                                        <tr>
                                            <th scope="col" colspan="7"><h6
                                                    class="text-center">{{__('No tasks found')}}</h6></th>
                                        </tr>
                                    @endif
                                    </tbody>
                                </table>
                            ...
                            <div class="table-responsive">
                                <table id="" class="table  px-2">
                                    ...
                                    @else
                                        <tr>
                                            <th scope="col" colspan="7"><h6
                                                    class="text-center">{{__('No milestone found')}}</h6></th>
                                        </tr>
                                    @endif
                                    </tbody>
                                </table>
                            ...
                            <div class="table-responsive">
                                <table class="table ">
                                    ...
                                    @else
                                        <tr>
                                            <th scope="col" colspan="7"><h6
                                                    class="text-center">{{__('No Bug found')}}</h6></th>
                                        </tr>
                                    @endif
                                    </tbody>
                                </table>
                        ...
                        <div class="card-body table-border-style">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    @else
                                        <tr>
                                            <th scope="col" colspan="5"><h6
                                                    class="text-center">{{__('No Expense Found.')}}</h6></th>
                                        </tr>
                                    @endif
                                    </tbody>
                                </table>
                    ...
                    <div class="card  activity-scroll">
                        ...
                        <div class="card-body p-3 vertical-scroll-cards">
                            ...
                            @else
                                <tr>
                                    <th scope="col" colspan="7"><h6
                                            class="text-center">{{__('No activities found')}}</h6></th>
                                </tr>
                            @endif
                        </div>
                    </div>
