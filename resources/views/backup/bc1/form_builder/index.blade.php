...
@section('action-btn')
    <div class="float-end">
        <a href="#" data-size="md" data-url="{{ route('form_builder.create') }}" data-ajax-popup="true"
           data-bs-toggle="tooltip" title="{{__('Create New Form')}}" class="btn btn-sm btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="action-btn me-2">
                                            <a href="#"
                                               class="mx-3 btn btn-sm align-items-center cp_link bg-warning-subtle"
                                               data-link="<iframe src='{{url('/form/'.$form->code)}}' title='{{ $form->name }}'></iframe>"
                                               data-bs-toggle="tooltip" title="{{__('Click to copy iframe link')}}"><i
                                        ...
                                        @if(\Auth::user()->type=='company' || \Auth::user()->type=='accou   ntant')
                                            <div class="action-btn me-2">
                                                <a href="#"
                                                   class="mx-3 btn btn-sm align-items-center bg-light-blue-subtitle"
                                        ...
                                        <div class="action-btn me-2">
                                            <a href="#" class="mx-3 btn btn-sm align-items-center cp_link bg-primary"
                                               data-link="{{url('/form/'.$form->code)}}" data-bs-toggle="tooltip"
                                               title="{{__('Click to copy link')}}"><i
                                        ...
                                        <div class="action-btn me-2">
                                            <a href="{{route('form_builder.show',$form->id)}}"
                                               ...
                                               data-bs-toggle="tooltip" title="{{__('Form field')}}"><i
                                        ...
                                        <div class="action-btn me-2">
                                            <a href="{{route('form.response',$form->id)}}"
                                               ...
                                               data-bs-toggle="tooltip" title="{{__('View Response')}}"><i
