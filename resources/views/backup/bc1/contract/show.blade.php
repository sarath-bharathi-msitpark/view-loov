...
@section('page-icon')
    {{ asset('assets/assestsnew/contracts.png') }}
@endsection
                                                ...
                                                <div class="col">
                                                    ...
                                                    <p class="card-text small text-muted">
                                                        @if (!empty($file->files) && file_exists(storage_path('contract_attechment/' . $file->files)))
                                                            {{ number_format(\File::size(storage_path('contract_attechment/' . $file->files)) / 1048576, 2) . ' show.blade.php' . __('MB') }}
                                                        @endif
                                                    </p>
                                                </div>
                        ...
                        @if (\Auth::user()->type == 'company')
                            <div class="col-12 d-flex">
                                <div class="form-group mb-0 form-send w-100">
                                    ...
                                    <div class="form-group">
                                        <textarea rows="3" class="form-control grammer_textarea" name="notes"
