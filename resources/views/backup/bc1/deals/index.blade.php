...
@section('action-btn')
    <div class="float-end">
        ...
        {{ Form::select('default_pipeline_id', $pipelines, $pipeline->id, ['class' => 'form-control select me-4', 'id' => 'default_pipeline_id', 'style' => 'min-width: 200px;']) }}
        {{ Form::close() }}
                                    ...
                                    <div class="sales-item-bottom d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="user-group">
                                            @foreach ($deal->users as $user)
                                                <img
                                                    src="@if ($user->avatar) {{ asset('/storage/uploads/avatar/' . $user->avatar) }} @else {{ asset('storage/uploads/avatar/avatar.png') }} @endif"
