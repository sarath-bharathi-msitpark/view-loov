...
@section('page-icon')
    {{ asset('assets/assestsnew/deals.png') }}
@endsection
...
@section('action-btn')
    <div class="float-end">
        @if (!empty($deal))
            <a href="{{ $deal->is_active ? route('deals.show', $deal->id) : '#' }}"
                                            ...
                                            <div class="d-block d-sm-flex align-items-start">
                                                <div
                                                    ...
                                                    <input class="form-check-input task-checkbox" type="checkbox"
                                                           ...
                                                           @if ($task->status) checked="checked"
                                                           @endcan value="{{ $task->status }}"
                                                           data-url="{{ route('deals.tasks.update_status', [$deal->id, $task->id]) }}">
                                                    <label class="form-check-label pe-5"
                                                           for="task_{{ $task->id }}"></label>
                                                </div>
                                                <div class="w-100">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="mb-3 mb-sm-0">
                                                            <h5 class="mb-0">
                                                                ...
                                                                @if ($task->status)
                                                                    <div
                                                                        class="badge bg-primary mb-1">{{ __(\App\Models\DealTask::$status[$task->status]) }}</div>
                                                                @else
                                                                    <div
                                                                        class="badge bg-warning mb-1">{{ __(\App\Models\DealTask::$status[$task->status]) }}</div>
                                                                @endif
                                                            </h5>
                                                            <small
                                                        ...
                                                        @if ($task->status)
                                                                    <div
                                                                        class="badge status_badge badge-pill badge-success mb-1">
                                                                {{ __(\App\Models\DealTask::$status[$task->status]) }}
                                                            </div>
                                                                @else
                                                                    <div
                                                                        class="badge status_badge badge-pill badge-warning mb-1">
                                                                {{ __(\App\Models\DealTask::$status[$task->status]) }}
                                                            </div>
                                                                @endif
                                                    </span>
                        ...
                        <div class="row">
                                            ...
                                            @if (!$deal->discussions->isEmpty())
                                                @foreach ($deal->discussions as $discussion)
                                                    <li class="list-group-item px-0">
                                                        <div class="d-block d-sm-flex align-items-start">
                                                            <img
                                                                src="@if ($discussion->user->avatar) {{ asset('/storage/uploads/avatar/' . $discussion->user->avatar) }} @else {{ asset('/storage/uploads/avatar/avatar.png') }} @endif"
                                                                class="rounded border-2 border border-primary wid-40 me-3 mb-2 mb-sm-0"
                                                                alt="image">
                                                            <div class="w-100">
                                                                <div
                            ...
                            <div class="col-md-6 col-12 mb-4">
                                <div class="card h-100 mb-0">
                                    ...
                                    <div class="card-body">
                                        <textarea class="summernote-simple grammer_textarea"
                                                  name="note">{!! $deal->notes !!}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
