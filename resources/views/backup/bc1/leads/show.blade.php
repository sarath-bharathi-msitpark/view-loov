                ...
                <div class="col-xl-9">
                    ...
                    <div id="general" class="row">
                        <div class="col-md-4 col-sm-6 col-12 mb-4 ">
                            <div class="card report-card h-100 mb-0 bg-white">
                    ...
                    <div id="users_products">
                        <div class="row">
                            <div class="col-md-6 col-12 mb-5">
                                <div class="card h-100 mb-0 bg-white">
                                ...
                                <div class="card h-100 mb-0 bg-white">
                                    <div class="card-header">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                                            ...
                                            @endphp
                                            @if ($plan->chatgpt == 1)
                                                <div class="float-end d-flex flex-wrap align-items-center gap-2 mt-4">
                                                    <a href="#" data-size="md"
                    ...
                    <div id="files" class="card bg-white">
                        <div class="card-header ">
                            <h5>{{ __('Files') }}</h5>
                        </div>
                    ...
                    <div id="calls" class="card bg-white">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h5>{{ __('Calls') }}</h5>
                    ...
                    <div id="activity" class="card bg-white">
                        <div class="card-header">
                            <h5>{{ __('Activity') }}</h5>
                        </div>
                        <div class="card-body ">
                            ...
                            <div class="row leads-scroll">
                                <ul class="event-cards list-group list-group-flush mt-3 w-100 px-4">
