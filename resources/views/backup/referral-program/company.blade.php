                            ...
                            <div class="card-body">
                                <div class="row align-items-center justify-content-between gy-3">
                                    <div class="col-md-6 col-12 payout-card">
                                        <div class="payout-card-inner d-flex align-items-center gap-3">
                                            ...
                                            <h3 class="mb-0">{{ $currency . \Auth::user()->commission_amount }}</h3>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12 payout-card">
                                        <div class="payout-card-inner d-flex align-items-center gap-3">
                                            ...
                                            <div class="payout-content flex-1">
                                                <span class="text-muted text-sm d-block mb-1">{{ __('Paid') }}</span>
                                                <h2 class="h5 mb-0">{{ __('Paid Amount') }}</h2>
                                            </div>
                                            <h3 class="mb-0">{{ $currency . $paidAmount }}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
