...
@section('action-btn')
    <div class="float-end d-flex gap-2">
        <a href="{{ route('organization.task.bug', $project->id) }}" data-bs-toggle="tooltip" title="{{ __('List') }}"
                    ...
                    <div class="col">
                        <div class="crm-sales-card mb-4">
                            <div class="card-header d-flex align-items-center gap-3">
                                ...
                                <span class="f-w-600 text-light bg-primary">{{ count($bugs) }}</span>
                            </div>
                                    ...
                                    <div class="sales-item draggable-item" id="{{ $bug->id }}">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <h5 class="mb-0 flex-1">
                                                    <a href="#" class="dashboard-link"
                                                       data-url="{{ route('organization.task.bug.show', [$project->id, $bug->id]) }}"
                                        ...
                                        <div
                                            ...
                                            <div class="user-group">
                                                <img
                                                    @if (isset($user[0]->avatar)) src="{{ asset('/storage/uploads/avatar/' . $user[0]->avatar) }}"
