...
<div class="modal-body">
    <div class="table-responsive">
        {{ Form::open(['route' => ['organization.projects.copy.link', $projectID], 'method' => 'POST']) }}
                ...
                <td class="action text-right">
                    <div class="form-check form-switch">
                        <input type="checkbox" name="basic_details" class="form-check-input"
                               @if (isset($result->basic_details) && $result->basic_details == 'on') checked="checked"
                               @endif id="copy_link_1"
                               value="on">
                ...
                <td class="action text-right">
                    <div class="form-check form-switch">
                        <input type="checkbox" name="member" class="form-check-input"
                               @if (isset($result->member) && $result->member == 'on') checked="checked"
                               @endif id="copy_link_2"
                               value="on">
                ...
                <td class="action text-right">
                    <div class="form-check form-switch">
                        <input type="checkbox" name="milestone" class="form-check-input"
                               @if (isset($result->milestone) && $result->milestone == 'on') checked="checked"
                               @endif id="copy_link_3"
                               value="on">
                ...
                <td class="action text-right">
                    <div class="form-check form-switch">
                        <input type="checkbox" name="attachment" class="form-check-input"
                               @if (isset($result->attachment) && $result->attachment == 'on') checked="checked"
                               @endif id="copy_link_5"
                               value="on">
                ...
                <td class="action text-right">
                    <div class="form-check form-switch">
                        <input type="checkbox" name="bug_report" class="form-check-input"
                               @if (isset($result->bug_report) && $result->bug_report == 'on') checked="checked"
                               @endif id="copy_link_7"
                               value="on">
                ...
                <td class="action text-right">
                    <div class="form-check form-switch">
                        <input type="checkbox" name="timesheet" class="form-check-input"
                               @if (isset($result->timesheet) && $result->timesheet == 'on') checked="checked"
                               @endif id="copy_link_10"
                               value="on">
                ...
                <td class="action text-right">
                    <div class="form-check form-switch">
                        <input type="checkbox" name="tracker_details" class="form-check-input"
                               @if (isset($result->tracker_details) && $result->tracker_details == 'on') checked="checked"
                               @endif id="copy_link_9"
                               value="on">
                ...
                <td class="action text-right">
                    <div class="form-check form-switch">
                        <input type="checkbox" name="expense" class="form-check-input"
                               @if (isset($result->expense) && $result->expense == 'on') checked="checked"
                               @endif id="copy_link_8"
                               value="on">
                ...
                <td class="action text-right">
                    <div class="form-check form-switch">
                        <input type="checkbox" name="activity" class="form-check-input"
                               @if (isset($result->activity) && $result->activity == 'on') checked="checked"
                               @endif id="copy_link_4"
                               value="on">
                ...
                <td class="action text-right">
                    <div class="form-check form-switch">
                        <input type="checkbox" name="password_protected" class="form-check-input password_protect"
                               ...
                               @if (isset($result->password_protected) && $result->password_protected == 'on') checked="checked"
                               @endif
                               value="on">
        ...
        <div class="modal-footer">
            ...
            <a href="#"
               id="{{ route('organization.projects.link', \Illuminate\Support\Facades\Crypt::encrypt($project->id)) }}"
