    ...
    <div class="float-end">
        ...
        @if ($view == 'grid')
            <a href="{{ route('organization.bugs.view', 'list') }}" class="btn btn-primary btn-sm me-1"
               ...
               title="{{ __('List View') }}">
                <span class="btn-inner--text"><i class="ti ti-list text-primary"></i></span>
            </a>
        @else
                ...
                <div class="card-body table-border-style">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center">
                            <thead>
                            <tr>
                                <th scope="col" style="position:unset">{{ __('Name') }}</th>
                                            ...
                                            <div class="avatar-group">
                                                ...
                                                @if ($user->count() > 0)
                                                    ...
                                                    <a href="#" class="avatar rounded-circle avatar-sm">
                                                        <img
                                                            data-original-title="{{ !empty($user[0]) ? $user[0]->name : '' }}"
                                                            @if ($user[0]->avatar) src="{{ asset('/storage/uploads/avatar/' . $user[0]->avatar) }}"
                            ...
                            @else
                                <tr>
                                    <td style="position:unset" colspan="7">
