{{ Form::model($milestone, array('route' => array('organization.project.milestone.update', $milestone->id), 'method' => 'POST', 'class'=>'needs-validation', 'novalidate')) }}
    ...
    @if($plan->chatgpt == 1)
        <div class="text-end">
            <a href="#" data-size="md" class="btn  btn-primary btn-icon btn-sm" data-ajax-popup-over="true"
               data-url="{{ route('organization.generate',['project milestone']) }}"
