...
@section('action-btn')
    <div class="float-end">
        ...
        <a href="#" class="btn bg-light-green-subtitle text-white btn-sm me-1" role="button" data-bs-toggle="dropdown"
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-steady dropdown_projects" id="task_sort">
        ...
        <a href="#" class="btn btn-primary-subtle text-white btn-sm me-1" role="button" data-bs-toggle="dropdown"
           aria-haspopup="true" aria-expanded="false">
            <span class="btn-inner--icon">{{__('Status')}}</span>
        </a>
        <div class="dropdown-menu dropdown-menu-right task-filter-actions dropdown-steady dropdown_projects" id="task_status">
        ...
        @if($view == 'grid')
            <a href="{{ route('organization.taskBoard.view', 'list') }}" class="btn btn-primary btn-sm" data-bs-toggle="tooltip"
               title="{{__('List View')}}">
                <span class="btn-inner--text"><i class="ti ti-list"></i>{{__('List View')}}</span>
            </a>
        @else
            <a href="{{ route('organization.taskBoard.view', 'grid') }}" class="btn btn-primary btn-sm" data-bs-toggle="tooltip"
               title="{{__('Grid View')}}">
...
@section('content')
    ...
    <div class="row min-750 pt-5" id="taskboard_view"></div>
@endsection
