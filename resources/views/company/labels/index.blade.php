...
@section('action-btn')
    @can('create label')
        <div class="d-flex flex-wrap align-items-center gap-2">
            <a href="#" data-size="md" data-url="{{ route('organization.labels.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip"
                                                ...
                                                @can('edit label')
                                                    <div class="action-btn me-2">
                                                        <a href="#" class="mx-3 btn btn-sm align-items-center bg-info"
                                                            data-url="{{ URL::to('organization/labels/' . $label->id . '/edit') }}"
                                                ...
                                                @if (count($pipeline['labels']))
                                                    @can('delete label')
                                                        <div class="action-btn ">
                                                            {!! Form::open(['method' => 'DELETE', 'route' => ['organization.labels.destroy', $label->id]]) !!}
                                                            <a href="#"
