...
@section('page-title') {{ __('Add Role') }} @endsection
...
.btn-submit { height:42px; padding:0 28px; border:none; border-radius:var(--radius-full); background:var(--primary); color:#fff; font-size:13.5px; font-weight:700; cursor:pointer; transition:all .18s; box-shadow:0 2px 8px rgba(37,99,235,.28); display:inline-flex; align-items:center; gap:6px; }
.btn-submit:hover { background:var(--primary-dark); transform:translateY(-1px); box-shadow:0 4px 14px rgba(37,99,235,.36); }
    ...
    $('#submitrole').click(function (e) {
        ...
        $.ajax({
            ...
            error: function (xhr) {
                ...
                $('#submitrole').prop('disabled', false).text('Create Role');
            }
        });
    });
});
...
<div class="col-12 entire_box1 mb-5">
    ...
    <div class="role-form-header">
        <div>
            <h1 class="role-form-title">Create New Role</h1>
            <p class="role-form-sub">Define a role and assign feature, report & settings permissions</p>
        </div>
    ...
    <form action="{{ route('organization.settings.role.store') }}" method="POST" id="createRoleForm">
        @csrf
            ...
            <div class="form-section-header">
                <div class="form-section-title">
                    ...
                    <div>
                        ...
                        <p class="form-section-sub">Name and describe this role</p>
                    </div>
                </div>
            </div>
            <div class="form-section-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="mform-input" placeholder="e.g. Team Manager" autocomplete="off" value="{{ old('name') }}">
                        <div class="text-danger mt-1 small" id="error-name"></div>
                    </div>
                    <div class="col-md-6">
                        <label class="mform-label">Description <span style="color:#DC2626">*</span></label>
                        <textarea name="description" class="mform-textarea" style="min-height:46px; resize:none;" placeholder="Briefly describe this role's purpose…">{{ old('description') }}</textarea>
                        <div class="text-danger mt-1 small" id="error-description"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-section-body">
                ...
                <div class="text-danger mt-2 small text-center" id="error-features"></div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-section-body">
                ...
                <div class="text-danger mt-2 small text-center" id="error-reports"></div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-section-body">
                ...
                <div class="text-danger mt-2 small text-center" id="error-settings"></div>
            </div>
        </div>
        ...
        <div class="form-actions">
            ...
            <button type="button" class="btn-submit" id="submitrole">
