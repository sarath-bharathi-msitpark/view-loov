    ...
    <div class="modal-content">
            ...
            <div class="col d-flex align-items-center">
                <div class="custom-control custom-checkbox mt-n1">
                    <input type="checkbox" class="custom-control-input" id="complete_task"
                           @if($task->is_complete == 1) checked
                           @endif data-url="{{ route('change.complete',[$task->project_id,$task->id]) }}">
            ...
            <div class="col-auto">
                <div class="actions text-end">
                    <div class="float-left">
                        <a href="#" class="action-item {{($task->is_favourite) ? 'action-favorite' : ''}} active"
                           data-url="{{ route('change.fav',[$task->project_id,$task->id]) }}" id="add_favourite"
                           data-toggle="tooltip" data-original-title="{{__('Mark as favorite')}}">
                        ...
                        <div class="card border shadow-none checklist-member">
                            <div class="px-3 py-2 row align-items-center">
                                <div class="col-10">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input"
                                               id="check-item-{{ $checklist->id }}" @if($checklist->status) checked
                                               @endif data-url="{{route('checklist.update',[$task->project_id,$checklist->id])}}">
                                ...
                                <div class="col-auto card-meta d-inline-flex align-items-center ml-sm-auto">
                                    <a href="#" class="action-item delete-checklist"
                            ...
                            <div class="px-3 py-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto actions">
                                        ...
                                        @auth('web')
                                            <a href="#" class="action-item delete-comment-file" role="button"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <a href="#" class="delete-comment"
                                       data-url="{{route('comment.destroy',[$task->project_id,$task->id,$comment->id])}}"><i
                                            class="ti ti-trash-alt text-danger"></i></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
        ...
        <div class="modal-footer">
            <div class="col-12 d-flex">
                <div class="pr-3">
                    <img {{ Auth::user()->img_avatar }} title="{{ Auth::user()->name }}"
                         class="avatar rounded-circle avatar-sm">
                </div>
                <form method="post" class="card-comment-box" id="form-comment"
                      data-action="{{route('comment.store',[$task->project_id,$task->id])}}">
