                        ...
                        <tr>
                            <td>
                                ...
                                <span class="d-block text-sm text-muted">{{ $task->project->name }}
                                    <span
                                        class="badge badge-xs badge-{{ (\Auth::user()->checkProject($task->project_id) == 'Owner') ? 'success' : 'warning'  }}">{{ __(\Auth::user()->checkProject($task->project_id)) }}</span>
                                </span>
                            </td>
                                    ...
                                    <div>
                                        <div class="progress" style="width: 100px;">
                                            <div class="progress-bar bg-{{ $task->taskProgress($task)['color'] }}"
                                                 role="progressbar"
                                                 aria-valuenow="{{ $task->taskProgress($task)['percentage'] }}"
