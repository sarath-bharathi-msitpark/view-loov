                                    ...
                                    <div class="col-12">
                                        <div class="actions d-inline-block">
                                            ...
                                            @if(count($task->comments) > 0)
                                                <div class="action-item mr-2"><i
                                                        class="ti ti-brand-hipchart mr-2"></i>{{ count($task->comments) }}
                                                </div>
                                            @endif
                                            @if($task->checklist->count() > 0)
                                                <div class="action-item mr-2"><i
                                                        class="ti ti-tasks mr-2"></i>{{ $task->countTaskChecklist() }}
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-5">@if(!empty($task->end_date) && $task->end_date != '0000-00-00')
                                            <small
