...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('organization.leads.index') }}">{{ __('Lead') }}</a></li>
...
@section('action-btn')
    <div class="float-end">
        ...
        <a href="#" data-url="{{ URL::to('organization/leads/' . $lead->id . '/labels') }}" data-ajax-popup="true" data-size="lg"
            data-bs-toggle="tooltip" title="{{ __('Label') }}" class="btn btn-sm btn-primary me-1">
            <i class="ti ti-bookmark"></i>
        </a>--}}
        <a href="#" data-size="lg" data-url="{{ route('organization.leads.edit', $lead->id) }}" data-ajax-popup="true"
            ...
            <div class="row">
                        ...
                        <div class="list-group list-group-flush" id="lead-sidenav">
                            ...
                            @if (Auth::user()->type != 'client')
                                <a href="#sources_emails"
                                    class="list-group-item list-group-item-action border-0 bg-white">{{ __('Sources') . ' | ' . __('Emails') }}
                                    <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                                </a>
                            @endif--}}
                            @if (Auth::user()->type != 'client')
                ...
                <div class="col-xl-9">
                    ...
                    <div id="general" class="row">
                        <div class="col-md-4 col-sm-6 col-12 mb-4 p-2">
                            <div class="card report-card h-100 mb-0 shadow-sm bg-white">
                                ...
                                <div class="h-100 mb-0">
                                    <div class="">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h5>{{ __('Users') }}</h5>
                                            <div class="float-end">
                                                <a data-size="md" data-url="{{ route('organization.leads.users.edit', $lead->id) }}"
                                ...
                                <div class="h-100 mb-0">
                                    <div class="">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h5>{{ __('Products') }}</h5>
                                            <div class="float-end">
                                                <a data-size="md" data-url="{{ route('organization.leads.products.edit', $lead->id) }}"
                                                    data-ajax-popup="true" data-bs-toggle="tooltip"
                                ...
                                <div class="h-100 mb-0">
                                    <div class="">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h5>{{ __('Sources') }}</h5>
                                            <div class="float-end">
                                                <a data-size="md" data-url="{{ route('organization.leads.sources.edit', $lead->id) }}"
                                                    data-ajax-popup="true" data-bs-toggle="tooltip"
                                    ...
                                    <div class="">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            @can('create lead email')
                                                <div class="float-end">
                                                    <a data-size="md" data-url="{{ route('organization.leads.emails.create', $lead->id) }}"
                                                        data-ajax-popup="true" data-bs-toggle="tooltip"
                                ...
                                <div class="h-100 mb-0">
                                    <div class="">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="float-end">
                                                <a data-size="lg"
                                                    data-url="{{ route('organization.leads.discussions.create', $lead->id) }}"
                                                    data-ajax-popup="true" data-bs-toggle="tooltip"
                        ...
                        <div class="">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                @can('create lead call')
                                    <div class="float-end">
                                        <a data-size="lg" data-url="{{ route('organization.leads.calls.create', $lead->id) }}"
                                                    ...
                                                    @can('edit lead call')
                                                        <div class="action-btn me-2">
                                                            <a href="#"
                                                                ...
                                                                data-url="{{ URL::to('organization/leads/' . $lead->id . '/call/' . $call->id . '/edit') }}"
