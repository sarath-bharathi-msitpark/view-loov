...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12 selecters_head">
                <div class="row gap-md-5">
                    <form method="GET" action="{{ route('organization.live_screenshot.index') }}" class="d-flex gap-3">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 mb-3">
                                <div
                                    ...
                                    <div
                                        ...
                                        {{--                                        <a href="#" class="webcam_liveshort popupTrigger"--}}
                                        {{--                                           data-id="{{ $employee->id }}"--}}
                                        ...
                                        <a href="#" class="system_liveshort popupTrigger w-100"
                                           data-id="{{ $employee->id }}"
                                           data-name="{{ $employee->name }}"
                                           data-code="{{ $employee->employee_id }}"
                                           data-designation="{{ $employee->designation->name ?? 'Team' }}">
    ...
    {{-- Global Loader --}}
    <!--<div id="global-loader" style="justify-content-center">-->
    <!--    <div class="d-flex align-items-center main_loaderinndiv">-->
    <!--        <img src="{{ asset('assets/assestsnew/loader.gif') }}" alt="Loading...">-->
    <!--        <h4 class="text-primary mb-0">Please Wait!</h4>-->
    <!--        <button id="loader-cancel-btn" class="close_btn_loadermodal"><i class="fa-solid fa-xmark"></i></button>-->
    <!--    </div>-->
    <!--</div>-->
    <div id="global-loader" style="justify-content: center; align-items: center; height: 100vh;">
        <div class="main_loaderinndiv text-center p-4 bg-white rounded shadow"
            ...
            <!-- Note -->
            <small class="text-muted">🍁 <span class="text-danger">Note:</span> If the employee is inactive, no
                screenshot will be taken.</small>
        </div>
    </div>
@endsection
