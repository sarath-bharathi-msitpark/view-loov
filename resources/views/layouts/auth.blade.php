...
<div class="custom-login">
    ...
    <div class="custom-login-inner">
        ...
        --}}
        <main class="custom-wrapper2 px-0">
...
@if ($get_cookie == 'on')
    @include('backup.layouts.cookie_consent')
@endif
...
<script>
    function togglePass(button) {
        ...
        var showButtonId = button.getAttribute('data-show-button-id');
        var hideButtonId = button.getAttribute('data-hide-button-id');
