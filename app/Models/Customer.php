...
class Customer extends Authenticatable
{
    ...
    {
        return $this->belongsTo(Area::class, 'billing_area');
    }

    public function shippingArea()
    {
        return $this->belongsTo(Area::class, 'shipping_area');
    }

    public function billingBeat()
    {
        return $this->belongsTo(Beat::class, 'billing_beat');
    }

    public function shippingBeat()
    {
        return $this->belongsTo(Beat::class, 'shipping_beat');
    }
}
