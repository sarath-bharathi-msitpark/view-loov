...
class ProjectTask extends Model
{
    ...
    public function getPriorityBadgeClass(): string
    {
        ...
        return $priorityClasses[$priority] ?? 'low_badge';
    }

    public static function getProgressClass($progress)
    {
        if ($progress <= 20) {
            return 'progress_fill_low';
        } elseif ($progress <= 70) {
            return 'progress_fill_easy';
        }
        return 'progress_fill_medium';
    }

    public static function getProgressLabel($progress)
    {
        if ($progress <= 20) {
            return 'Low';
        } elseif ($progress <= 70) {
    ...
    {
        return $this->getChecklistProgressAttribute();
    }
