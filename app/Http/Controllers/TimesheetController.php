...
class TimesheetController extends Controller
{
    public function timesheetView(Request $request, $project_id)
    {
        ...
        if (in_array($project_id, $project_ids)) {
            ...
            return view('company.projects.timesheets.index', compact('project'));
        }
    }
...
//        $authuser         = Auth::user();
    ...
    public function timesheetCreate(Request $request)
    {
        ...
        if ($project_id) {
            ...
            if (!empty($project) && count($project) > 0) {
                ...
                return view('company.projects.timesheets.create', compact('parseArray'));
            }
        } else {
            $projects = $projects->get();

            return view('company.projects.timesheets.create', compact('projects', 'project_id', 'selected_date'));
        }
    }
    ...
    public function timesheetEdit(Request $request, $project_id, $timesheet_id)
    {
        ...
        if ($timesheet) {
            ...
            if (!empty($project) && count($project) > 0) {
                ...
                return view('company.projects.timesheets.edit', compact('timesheet', 'parseArray'));
            }
        }
    }
    ...
    {
        return view('company.projects.timesheet_list');
    }
