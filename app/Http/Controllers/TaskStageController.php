...
class TaskStageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('company.task_stage.index', compact('task_stages'));
    }
    ...
    {
        return view('company.task_stage.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('company.project-task-stages.index')->with('success', __('Task Stage Add Successfully'));
    }
    ...
    public function edit(TaskStage $taskStage, $id)
    {
        ...
        if ($taskStage->created_by == \Auth::user()->creatorId()) {
            return view('company.task_stage.edit', compact('taskStage'));
        } else {
