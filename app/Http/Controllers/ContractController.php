...
class ContractController extends Controller
{
    public function index()
    {
        if (\Auth::user()->type == 'company') {
            ...
            return view('company.contract.index', compact('contracts', 'cnt_contract'));
        ...
        return view('company.contract.index', compact('contracts'));
    }
    ...
    public function create()
    {
        ...
        return view('company.contract.create', compact('contractTypes', 'clients', 'project'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('company.contract.index')->with('error', $messages->first());
        }
    ...
    public function show($id)
    {
        ...
        if ($contract->created_by == \Auth::user()->creatorId()) {
            ...
            return view('company.contract.show', compact('contract', 'client'));
        } else {
    ...
    public function edit(Contract $contract)
    {
        ...
        return view('company.contract.edit', compact('contractTypes', 'clients', 'contract', 'project'));
    }
    ...
    public function update(Request $request, Contract $contract)
    {
        ...
        return redirect()->route('company.contract.index')->with('success', __('Contract successfully updated.'));
    }
    ...
    public function destroy(Contract $contract)
    {
        ...
        return redirect()->route('company.contract.index')->with('success', __('Contract successfully deleted.'));
    }
    ...
    public function description($id)
    {
        ...
        return view('company.contract.description', compact('contract'));
    }
    ...
    public function grid()
    {
        if (\Auth::user()->type == 'company' || \Auth::user()->type == 'client') {
            ...
            return view('company.contract.grid', compact('contracts'));
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
