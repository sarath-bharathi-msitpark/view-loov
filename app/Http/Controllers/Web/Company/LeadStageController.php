...
class LeadStageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('company.lead_stages.index')->with('pipelines', $pipelines);
    }
    ...
    public function create()
    {
        ...
        return view('company.lead_stages.create')->with('pipelines', $pipelines);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('organization.lead_stages.index')->with('success', __('Lead Stage successfully created!'));
    }
    ...
    {
        return redirect()->route('company.lead_stages.index');
    }
    ...
    public function edit(LeadStage $leadStage)
    {
        if ($leadStage->created_by == \Auth::user()->ownerId()) {
            ...
            return view('company.lead_stages.edit', compact('leadStage', 'pipelines'));
        } else {
    ...
    public function update(Request $request, LeadStage $leadStage)
    {
        if ($leadStage->created_by == \Auth::user()->ownerId()) {
            ...
            if ($validator->fails()) {
                ...
                return redirect()->route('organization.lead_stages.index')->with('error', $messages->first());
            }
            ...
            return redirect()->route('organization.lead_stages.index')->with('success', __('Lead Stage successfully updated!'));
        } else {
    ...
    public function destroy(LeadStage $leadStage)
    {
        ...
        return redirect()->route('organization.lead_stages.index')->with('success', __('Lead Stage successfully deleted!'));
    }
