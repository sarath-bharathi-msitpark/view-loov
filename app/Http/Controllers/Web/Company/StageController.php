...
class StageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('company.stages.index')->with('pipelines', $pipelines);
    }
    ...
    public function create()
    {
        ...
        return view('company.stages.create')->with('pipelines', $pipelines);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('organization.stages.index')->with('success', __('Deal Stage successfully created!'));
    }
    ...
    {
        return redirect()->route('organization.stages.index');
    }
    ...
    public function edit(Stage $stage)
    {
        if ($stage->created_by == \Auth::user()->ownerId()) {
            ...
            return view('company.stages.edit', compact('stage', 'pipelines'));
        } else {
    ...
    public function update(Request $request, Stage $stage)
    {
        ...
        if ($stage->created_by == \Auth::user()->ownerId()) {
            ...
            $stage->pipeline_id = $request->pipeline_id;
            $stage->save();
            return redirect()->route('organization.stages.index')->with('success', __('Deal Stage successfully updatedd!'));
        } else {
    ...
    public function destroy(Stage $stage)
    {
        if ($stage->created_by == \Auth::user()->ownerId()) {
            ...
            if ($deals == 0) {
                ...
                return redirect()->route('organization.stages.index')->with('success', __('Deal Stage successfully deleted!'));
            } else {
                return redirect()->route('organization.stages.index')->with('error', __('There are some deals on stage, please remove it first!'));
            }
        } else {
            return redirect()->back()->with('error', __('Permission Denied.'));
        }
