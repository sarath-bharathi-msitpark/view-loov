...
class CouponController extends Controller
{
    ...
    public function index()
    {
        if(\Auth::user()->can('manage coupon'))
        {
            ...
            return view('shared.coupon.index', compact('coupons'));
        }
        else
        {
    ...
    public function create()
    {
        ...
        {
            return view('shared.coupon.create');
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('create coupon'))
        {
            ...
            return redirect()->route('general.coupons.index')->with('success', __('Coupon successfully created.'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function show(Coupon $coupon)
    {
        ...
        return view('shared.coupon.view', compact('userCoupons'));
    }
    ...
    public function edit(Coupon $coupon)
    {
        ...
        {
            return view('shared.coupon.edit', compact('coupon'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function update(Request $request, Coupon $coupon)
    {
        if(\Auth::user()->can('edit coupon'))
        {
            ...
            return redirect()->route('general.coupons.index')->with('success', __('Coupon successfully updated.'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function destroy(Coupon $coupon)
    {
        if(\Auth::user()->can('delete coupon'))
        {
            ...
            return redirect()->route('general.coupons.index')->with('success', __('Coupon successfully deleted.'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function applyCoupon(Request $request)
    {
        ...
        {
            $original_price = self::formatPrice($plan->getTotalPlanAmount($plan->id));
            ...
            if(!empty($coupons))
            {
                ...
                if($coupons->limit == $usedCoupun)
                {
                    return response()->json(
                        [
                            ...
                            'price' => number_format($plan->getTotalPlanAmount($plan->id), Utility::getValByName('decimal_number')),
                ...
                else
                {
                    ...
                    $plan_price     = $plan->getTotalPlanAmount($plan->id)- $discount_value;
                    $price          = self::formatPrice($plan->getTotalPlanAmount($plan->id) - $discount_value);
