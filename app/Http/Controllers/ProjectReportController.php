...
class ProjectReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('company.project_report.index', compact('projects', 'users', 'status', 'last_task'));
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        if ($user) {
            ...
            return view('company.project_report.show', compact('user', 'users', 'arrProcessPer_status_task', 'arrProcess_Label_priority', 'esti_logged_hour_chart', 'logged_hour_chart', 'arrProcessPer_priority', 'arrProcess_Label_status_tasks', 'project', 'milestones', 'daysleft', 'chartData', 'arrProcessClass', 'stages', 'tasks', 'last_task'));
