...
class DealController extends Controller
{
    ...
    public function index()
    {
        ...
        if (!$pipeline) {
            return redirect()->back()->with('error', __('No pipeline found.'));
        }
        ...
        return view('company.deals.index', compact('pipelines', 'pipeline', 'cnt_deal'));
    }
    ...
    public function deal_list()
    {
        ...
        return view('company.deals.list', compact('pipelines', 'pipeline', 'deals', 'cnt_deal'));
    }
    ...
    public function create()
    {
        ...
        return view('company.deals.create', compact('clients', 'customFields'));
    }
...
//                    return redirect()->back()->with('success', __('Deal successfully created!')  .(($resp['is_success'] == false && !empty($resp['error'])) ? '<br> <span class="text-danger">' . $resp['error'] . '</span>' : ''));
    ...
    public function show(Deal $deal)
    {
        if ($deal->is_active) {
            ...
            return view('company.deals.show', compact('deal', 'customFields', 'calenderTasks', 'permission'));
        } else {
    ...
    public function edit(Deal $deal)
    {
        if ($deal->created_by == \Auth::user()->ownerId()) {
            ...
            return view('company.deals.edit', compact('deal', 'pipelines', 'sources', 'products', 'customFields'));
        } else {
...
//                ClientPermission::where('deal_id', '=', $deal->id)->delete();
    ...
    public function labels($id)
    {
        ...
        if ($deal->created_by == \Auth::user()->ownerId()) {
            ...
            return view('company.deals.labels', compact('deal', 'labels', 'selected'));
        } else {
            return response()->json(['error' => __('Permission Denied.')], 401);
        }
    }
    ...
    public function userEdit($id)
    {
        ...
        if ($deal->created_by == \Auth::user()->ownerId()) {
            ...
            return view('customer.deals.users', compact('deal', 'users'));
        } else {
            return response()->json(['error' => __('Permission Denied.')], 401);
        }
    }
    ...
    public function clientEdit($id)
    {
        ...
        if ($deal->created_by == \Auth::user()->ownerId()) {
            ...
            return view('customer.deals.clients', compact('deal', 'clients'));
        } else {
            return response()->json(['error' => __('Permission Denied.')], 401);
        }
    }
    ...
    public function productEdit($id)
    {
        if (\Auth::user()->can('edit deal')) {
            ...
            if ($deal->created_by == \Auth::user()->ownerId()) {
                ...
                return view('company.deals.products', compact('deal', 'products'));
            } else {
                return response()->json(['error' => __('Permission Denied.')], 401);
            }
        } else {
    ...
    public function taskCreate($id)
    {
        ...
        if ($deal->created_by == \Auth::user()->ownerId()) {
            ...
            return view('company.deals.tasks', compact('deal', 'priorities', 'status'));
        } else {
            return response()->json(
                [
                    'is_success' => false,
