...
class ClientController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if ($request->ajax) {
            return view('company.clients.createAjax');
        } else {
            $customFields = CustomField::where('module', '=', 'client')->get();

            return view('company.clients.create', compact('customFields'));
        }
    }
    ...
    public function edit(User $client)
    {
        ...
        if ($client->created_by == $user->creatorId()) {
            ...
            return view('company.clients.edit', compact('client', 'customFields'));
        } else {
    ...
    public function clientPassword($id)
    {
        ...
        return view('company.clients.reset', compact('user', 'client'));
    }
