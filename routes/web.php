...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::get('/company/clients', [ClientController::class, 'index'])->name('company.clients.index');
...
//            return view('settings.workplace');
...
//            return view('settings.shift');
//        })->name('settings.shift');
//
//        Route::get('/break', function () {
//            return view('settings.break');
//        })->name('settings.break');
//
//        Route::get('/designation', function () {
//            return view('settings.designation');
//        })->name('settings.designation');
//
...
//    });
//
Route::group(['prefix' => '/employee-web'], function () {
    Route::get('/attendance', function () {
        return view('employee_web.attendance.index');
    })->name('employee.attendance');

    Route::get('/view-log', function () {
        return view('employee_web.view_log.index');
    })->name('employee.view_log');

    Route::get('/break-insight', function () {
        return view('employee_web.break_insight.index');
    })->name('employee.break_insight');

    Route::get('/activity', function () {
        return view('employee_web.activity.index');
...
Route::group(['prefix' => '/report'], function () {
    ...
    Route::get('/break', function () {
        return view('reports.break_report');
    })->name('report.break');

    Route::get('/attendance', function () {
        return view('reports.daily_attendance_report');
    ...
    Route::get('/apps-and-urls', function () {
        return view('reports.app_and_url_report');
    })->name('report.apps_and_urls');

    Route::get('/highlight', function () {
        return view('reports.highlight');
...
Route::group(['prefix' => '/live-screen-shot'], function () {
    Route::get('/', function () {
        return view('live_screen_shot.index');
    })->name('live_screenshot.index');
});

Route::group(['prefix' => '/apps-and-url'], function () {
    Route::get('/', function () {
        return view('apps_and_urls.index');
    })->name('apps_and_urls.index');
});
//});
